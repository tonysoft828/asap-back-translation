...
parser.add_argument('-b', '--back-translation-file', dest='back_translation_file', default="../bt-essays/05.fr-en/ee.txt", help='Input txt back-translation essays file')
parser.add_argument('-o', '--output-file', dest='output_file', default="../data/training_bt_fr.tsv", help='Output TSV file')
